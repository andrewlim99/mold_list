(function (root) {
  ...
  const dictionary = {
    'Select Request By before uploading photos.':'上傳照片前請先選擇申請人。',
    'Mold QC':'模具 QC','Item Checked':'本項目已確認',
    'Mold Leader':'模具主管','Repair QC':'維修 QC','Post-injection QC':'射出後 QC','Post-injection QC Leader':'射出後 QC 主管',
    'Approve':'核准','Reject':'退回','Rejected':'已退回','Approver name':'核准人姓名',
    'Rejection reason (required)':'退回原因（必填）','Approval comment (optional)':'核准意見（選填）',
    'Enter the approver name.':'請填寫核准人姓名。','Enter a rejection reason.':'請填寫退回原因。',
    'Save Work Order changes before approving or rejecting.':'核准或退回前請先儲存申請單。',
    'Rejected. Returned to Repair Waiting.':'已退回至維修待處理。','Approval saved.':'核准已儲存。',
    'All Items Checked':'所有項目已確認','QC Comment':'QC 評語','QC Comment:':'QC 評語：',
    'Photo Preview':'照片預覽','Close photo':'關閉照片',
    'Upload Photo':'上傳照片',
    'No photo selected':'尚未選擇照片','Photo uploaded':'照片已上傳',
    'Remove photo':'移除照片','Up to 20 photos are allowed for each Before / After section.':'作業前與作業後各最多可上傳 20 張照片。',
    ...
    'Enter the Mold Team Technician before uploading photos.':'上傳照片前請先填寫模具組技術員。',
    ...
    'No.':'項次','Modification':'修改內容','Done By':'作業人員','Mold Team Technician':'模具組技術員',
    ...
    'choose Visual or Dimensional.':'請選擇外觀或尺寸。','enter the mold team technician.':'請填寫模具組技術員。',
